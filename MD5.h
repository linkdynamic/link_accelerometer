...
public:
  ...
  //static char* md5(const void *arg);
  static void hmac_md5(const void *text, int text_len,void *key, int key_len, unsigned char *digest);
  static char* hmac_md5(const void *text, int text_len,void *key, int key_len);
};
